...
public class PersonaServicio {
    ...
    public Persona crearPersona() {
        ...
        while (edad < 0) {
            System.out.println("La edad no es valida, intente nuevamente");
            edad = leer.nextInt();
        }
        ...
        while (peso < 0) {
            System.out.println("El peso no es valida, intente nuevamente");
        ...
        while (altura < 0) {
            System.out.println("La altura no es valida, intente nuevamente");
